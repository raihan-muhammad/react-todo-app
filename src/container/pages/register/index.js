    ...
    return (
      <div className="login">
        <div className="login__kanan">
          <p className="login__todo-text">
            Todo<span>App</span>
          </p>
          {this.state.success !== "" ? (
            <p className="login__success-text">{this.state.success}</p>
          ) : null}
          ...
          <p className="login__text-biasa">
            Sudah mempunyai akun? <Link to="/react-todo-app">Login</Link>
          </p>
          <Button
            title="Register"
